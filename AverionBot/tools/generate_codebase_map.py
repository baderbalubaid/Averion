...
DOCS_DIR = os.path.join(AVERION_DIR, 'AverionBot', 'docs')
OUTPUT_MD = os.path.join(DOCS_DIR, 'CODEBASE_MAP.md')
OUTPUT_JSON = os.path.join(DOCS_DIR, 'codebase_map.json')
...
with open(os.path.join(DOCS_DIR, 'architecture', 'database_er.mmd'), 'w') as f:
    f.write("erDiagram\n")
    seen_rels = set()
...
def write_concept_diagram(concept_name, concept_tables, endpoint_keyword):
    ...
    path = os.path.join(DOCS_DIR, 'architecture', f'{concept_name}.mmd')
